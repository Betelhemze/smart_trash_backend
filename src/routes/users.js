...
router.post("/login", async (req, res) => {
  ...
  try {
    ...
    // Correct: result.rows, not result.row
    ...
    // Compare phone_hash (hashed in DB)
    const valid = await bcrypt.compare(phone_hash, user.phone_hash);
